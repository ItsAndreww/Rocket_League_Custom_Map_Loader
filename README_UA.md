...
Якщо у вас не встановлено Python, ви можете завантажити останню автономну версію з розділу **[Releases](https://github.com/ItsAndreww/Rocket_League_Custom_Map_Loader/releases)**. Для скомпільованої версії не потрібні додаткові залежності. Відразу готова до роботи програма.
